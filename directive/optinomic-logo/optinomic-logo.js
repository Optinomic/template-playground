...
//                of logo
//
//  radius        Size of radius - logo Circels
//
//  yoverride     Correct Y of logo Circels
//
//  src_stretch   scr file will be stretched with this factor.
//
...
angular.module('optinomic').directive('optinomicLogo', function() {
  ...
  function postLink(scope, elm, as) {
    ...
    var myradius = as.radius || 0.95;
    var yoverride = as.yoverride || 1;
    var srcstretch = as.srcstretch || 2;
    ...
    var outer_circle_radius = myradius * svg_height / 2;
    ...
    if (logo_src) {
      d3.xml(logo_src, "image/svg+xml", function(xml) {
        ...
        var ctrxlat = "translate(" + (inner_circ.x - offset) + "," +
          inner_circ.y * yoverride + ")";
        var scale_factor = size / 200 * srcstretch;
